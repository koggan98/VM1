...
MARKER_SEPARATION = 0.2  # Abstand zwischen den Markern in Metern
BOARD_ROWS = 2
BOARD_COLS = 2
...
class ArucoBoard(Node):
    ...
    def detect_and_publish(self):
        ...
        if ids is not None:
            ...
            self.publish_camera_frame(T_fixed, "world", "camera_frame")
    ...
    def publish_aruco_board_frame(self):
        ...
        static_transform.header.frame_id = "world"  # Basisframe des Roboters
        static_transform.child_frame_id = "aruco_board_frame"

        # Hard Coded Pose des ArUco-Boards relativ zur Roboterbasis
        static_transform.transform.translation.x = 0.0
        static_transform.transform.translation.y = -0.4  # Beispiel: Verschiebung um -0.5 m in y-Richtung
